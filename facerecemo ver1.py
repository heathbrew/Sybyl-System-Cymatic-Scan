...
def markAttendence(name):
    with open('Face recognition attendence\spotted.csv', 'r+') as f:
...
while True:
    ...
    with the faces present in the directory"""
        ...
        for encodeFace,faceLoc in zip(encodesCurFrame,facesCurFrame):
            ...
            #border for text
                cv2.putText(imgimported,str(CrimeCoff)+" "+str(name),(x1+6,y2-6),cv2.FONT_HERSHEY_COMPLEX,1,(255,255,255),2)
